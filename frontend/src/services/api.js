...
// Support Hub
export const raiseSupportTicket = (data) => API.post("/support/ticket", data);
export const getSupportTickets = () => API.get("/support/all");
export const updateSupportTicketStatus = (id, status) => API.put(`/support/${id}/status`, { status });
